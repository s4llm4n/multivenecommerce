                        ...
                        <tbody>
                            {
                                [1,2,3,4,5].map((d, i) => <tr className='border-b  border-slate-700' key={i}>
                                    ...
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'><img className='w-[45px] h-[45px]' src={`http://localhost:3000/images/category/${d}.jpg`} alt=''/></td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>Salman Hatrash</td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>s4llm4n@gmail.com</td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'><span>Pending</span></td>
                                    <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'><span>Deactive</span></td>
