                    ...
                    <div className='w-full text-sm  text-left [#d0d2d6]'>
                        ...
                        <div className='text-[#d0d2d6]'>
                            <div className='flex justify-between items-start border-b border-slate-700'>
                                ...
                                <div onClick={(e) => setShow(!show)} className='py-3 w-[9%] font-medium'><LuCircleArrowDown/></div>
                            </div>
                            <div className={show ? 'block border-b border-slate-700 bg-[#8288ed]' : 'hidden'}>
                            <div className='flex justify-start items-start border-b border-slate-700'>
                                <div className='py-3 w-[25%] font-medium whitespace-nowrap pl-3'>#54634</div>
                                <div className='py-3 w-[13%] font-medium'>$561</div>
                                <div className='py-3 w-[18%] font-medium'>Pending</div>
                                <div className='py-3 w-[18%] font-medium'>Pending</div>
                            </div>
                            <div className='flex justify-start items-start border-b border-slate-700'>
