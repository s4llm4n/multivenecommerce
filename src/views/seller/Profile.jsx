                    ...
                    <div className='w-full p-4 bg-[#6a5fdf] rounded-md text-[#d0d2d6]'>
                        <div className='flex justify-center items-center py-3'>
                            {
                                ...
                                </label> : <label className='flex justify-center items-center flex-col h-[210px] w-[300px] 
                        ...
                        <div className='px-0 md:px-5 py-2'> 
                            ...
                            rounded-md relative'>
                                ...
                                hover:shadow-yellow-500/50 absolute right-2 top-2 cursor-pointer'><FaRegEdit />
                                </span>
                                    ...
                                    <p>
                                        {
                                            ...
                                            rounded'>{userInfo.payment}</span> : <span onClick={() => dispatch(create_stripe_connect_account())} className='bg-blue-500 text-white 
                                            text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 
                ...
                <div className='w-full md:w-6/12'>
                            <div className='w-full pl-0 md:pl-7 mt-6 md:mt-0'>
                                ...
                                <div className='flex flex-col w-full gap-1 mb-2'>
                                    ...
                                    outline-none bg-[#6a5fdf] border border-slate-700 
                                    rounded-md text-[#d0d2d6]' type='text' name='email' 
                                ...
                                <div className='flex flex-col w-full gap-1 mb-2'>
                                    ...
                                    <input className='px-4 py-2 focus:border-indigo-500 
                                    outline-none bg-[#6a5fdf] border border-slate-700 
                                    rounded-md text-[#d0d2d6]' type='password' name='old_password' 
                                    id='o_password' placeholder='Old Password'/>
                                </div>
                                <div className='flex flex-col w-full gap-1 mb-2'>
                                    <label htmlFor='n_password'>New Password</label>
                                    <input className='px-4 py-2 focus:border-indigo-500 
                                    outline-none bg-[#6a5fdf] border border-slate-700 
                                    rounded-md text-[#d0d2d6]' type='password' name='new_password' 
                                    id='n_password' placeholder='New Password'/>
                                </div>
