...
function handleOnWheel({ deltaY }) {
    console.log('handleOneWheel',deltaY)
}
    ...
    const Row = ({ index, style }) => {
        return (
            <div style={style} className='flex text-sm text-white font-medium'>
                ...
                <div className='w-[25%] p-2 whitespace-nowrap'>$2545</div>
                                ...
                                <div className='pt-5 mb-5'>
                                    <form>
                                        <div className='flex gap-3 flex-wrap'>
                                            <input min='0' type='number' className='px-3 py-2 md:w-[75%] 
                                            focus:border-indigo-200 outline-none bg-[#6a5fdf] 
                                            border border-slate-700 rounded-md text-[#d0d2d6]' name='amount'/>
